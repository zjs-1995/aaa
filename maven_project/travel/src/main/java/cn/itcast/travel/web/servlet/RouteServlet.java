...
import cn.itcast.travel.service.impl.FavoriteServicecImpl;
...
public class RouteServlet extends BaseServlet {
    ...
    private FavoriteServicec favoriteServicec = new FavoriteServicecImpl();
    ...
    public void isFavorite(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //调用FavoriteServicec查询是否收藏
        boolean flag = favoriteServicec.isFavorite(rid, uid);
        //写回客户端
